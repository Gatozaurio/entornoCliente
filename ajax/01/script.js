...
document.addEventListener('DOMContentLoaded', function(){
    ...
    boton.addEventListener('click', function(){
        xhr = new objetoXHR();
        xhr.open('GET', 'datos.php?edad=24&trabajo=programador', false);
        xhr.send(null);
    ...
    boton2.addEventListener('click', function(){
        xhr = new objetoXHR();
        xhr.open('GET', 'datos.php?edad=24&trabajo=programador', true);
...
function comprobarEstadoPeticion(){
    ...
    // Vamos mostrando el valor actual de readyState en cada llamada.
        ...
        case 4:
            ...
            let div = document.getElementById('resultadoAsincrono');
            div.appendChild(document.createTextNode(respuesta) );
            }
            break;
    }
